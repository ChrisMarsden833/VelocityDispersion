...
extern "C"
{
                           ...
                           int size)
    {
        ...
        printf("Preparing to calculate sigma for %i galaxies, using %i threads\n", size, threads);
        ...
        #pragma omp parallel for default(none) shared(progress, size, res, Aperture, redshift, bulge_mass, bulge_radius, bulge_beta, bulge_sersicIndex, componentFlag, disk_mass, disk_inclination, disk_scale_length, Halo_mass, profile_name, halo_concentration, BlackHole_mass, mode, threads, size, stdout) schedule(dynamic, 1)
